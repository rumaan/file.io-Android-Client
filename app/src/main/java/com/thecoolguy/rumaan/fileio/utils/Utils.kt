...
object Utils {
    ...
    fun getLocalFile(context: Context, fileUri: Uri): LocalFile? {
     ...
     */
    fun getFileInputStream(fileUri: Uri, context: Context): FileInputStream? {
    ...
    object Android {
        ...
        private fun newIntent(action: String, category: String, type: String): Intent {
            val intent = Intent()
        ...
        fun showDialogFragment(fragment: Fragment, fragmentManager: FragmentManager,
                               tag: String) {
    ...
    object JSONParser {
        ...
        fun getDaysFromExpireString(expiry: String?): Int {
            ...
            return Integer.parseInt(expiry.split(" ".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()[0])
        }
    }
